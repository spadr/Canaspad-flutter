...
import 'tube_view_model.dart';

class TubePage extends HookConsumerWidget {
  const TubePage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final theme = ref.watch(appThemeProvider);
    final state = ref.watch(tubeViewModelProvider);
    final viewModel = ref.watch(tubeViewModelProvider.notifier);
    final l10n = useL10n();
